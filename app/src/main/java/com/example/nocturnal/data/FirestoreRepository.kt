...
class FirestoreRepository {
    ...
    suspend fun getUsername(uid: String): String {
        ...
        return documentSnapshot.getString("username") ?: "Unknown User"
    }

    suspend fun storePost(media: String, timestamp: Date, uid: String, barID: String): String {
    ...
    suspend fun getUserPosts(uid: String): List<String> {
    ...
    suspend fun updateBarPostIds(barId: String, postId: String) {
        val barRef = db.collection("bars").document(barId)
        barRef.update("postIDs", FieldValue.arrayUnion(postId)).await()
    }
}
